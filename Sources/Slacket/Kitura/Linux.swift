...
extension String {
    ...
    func stringByAddingPercentEncoding() -> String? {
            ...
            let encodedString = self.stringByAddingPercentEncodingWithAllowedCharacters((NSCharacterSet.alphanumericCharacterSet().mutableCopy() as! NSMutableCharacterSet).addCharactersInString("_")) as! NSCharacterSet
