...
extension String {
    ...
    func stringByAddingPercentEncoding() -> String? {
            ...
            return self.stringByAddingPercentEncodingWithAllowedCharacters((NSCharacterSet.alphanumericCharacterSet().mutableCopy() as! NSMutableCharacterSet).addCharactersInString("_") as! NSCharacterSet)
        #else
